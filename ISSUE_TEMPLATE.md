...
ATTENTION! If you would like to submit an HIP and it has already been written as a draft (see the [template](https://github.com/HapticFinance/HIPs/blob/master/hip-X.md) for an example), please submit it as a [Pull Request](https://github.com/HapticFinance/HIPs/pulls).
