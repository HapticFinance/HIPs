...
import { AllHccpQuery } from '../../types/gql'
...
const Template: React.FC<Props> = ({ data: { allMarkdownRemark } }) => {
  ...
  )(group) as AllHccpQuery['allMarkdownRemark']['group']

  return (
    <Main>
      <Helmet title="All HCCPs" />
      <header className="post-header">
        <h1 className="post-title">All HCCPs</h1>
      </header>
      <div className="post-content">
        {columns.map((g) => {
          const rows = sortBy('frontmatter.hccp')(g.nodes)
          return (
